...
public class SpherePlayer : MonoBehaviour {
	...
	void Start()
	{
		...
		//thisRigidbody.centerOfMass = new Vector3 (0, -0.5f, 0);
	}
	...
	void Move(Vector3 dir)
	{
		...
		//this.thisRigidbody.AddForce(dir.normalized * moveSpeed);
	//	thisRigidbody.velocity += (dir * Time.deltaTime * moveSpeed).normalized;
	}
	void Jump()
	{
